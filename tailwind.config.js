...
export default {
  ...
  theme: {
  	extend: {
  		...
  		backgroundImage: {
  			'gradient-rainbow': 'linear-gradient(135deg, hsl(var(--brand-orange)) 0%, hsl(var(--brand-red-orange)) 100%)',
  			'gradient-primary': 'linear-gradient(135deg, hsl(var(--brand-orange)), hsl(var(--brand-red-orange)))',
